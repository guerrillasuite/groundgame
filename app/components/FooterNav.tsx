...
function Icon({ name }: { name: 'home'|'dial'|'door'|'text'|'user'|'store' }) {
  ...
  switch (name) {
    ...
    case 'store': return (<svg {...common} viewBox="0 0 24 24"><path fill="currentColor" d="M2 3h20l-2 7H4zm0 0 2 7h16M4 10v11h16V10M9 10v11M15 10v11"/></svg>);
  }
}
...
export function FooterNav({ features }: FooterNavProps) {
  ...
  const allItems = [
    ...
    { href: '/storefront', label: 'Store',   icon: 'store' as const, featureKey: 'pwa_storefront' as FeatureKey },
