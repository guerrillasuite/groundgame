...
import { S, makeSb, timeAgo, Dot } from "./_helpers";
...
export async function RecentActivity({ tenantId, settings }: { tenantId: string; settings: any }) {
  ...
  if (stops.length === 0) {
    return <p style={{ fontSize: 13, color: S.dim, fontStyle: "italic", margin: 0 }}>No stops recorded yet. Time to hit the field.</p>;
  }
