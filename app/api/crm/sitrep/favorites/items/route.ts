...
// ?userIds=id1,id2  (comma-separated auth user IDs)
export async function GET(req: NextRequest) {
  ...
  // Find all users who share a tenant with the current user (allowed IDs)
  ...
  // Also allow explicit favorites even if no shared tenant
