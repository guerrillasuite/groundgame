...
export default function Error({
  ...
  return (
    <>
      <style>{`
        @keyframes sr-glitch-entrance-500 {
        ...
        .sr-glitch-entrance-500 { animation: sr-glitch-entrance-500 5s ease-out forwards; }
        .sr-glitch-idle-500     { animation: sr-glitch-idle-500 4s linear infinite; animation-delay: 5s; }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span
            className="sr-glitch-entrance-500"
            style={{
          ...
          >
            <span className="sr-glitch-idle-500">500</span>
          </span>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: "var(--gg-dim, rgb(100 116 139))",
            marginBottom: 14,
          }}>
            Error 500
          </div>
          ...
          <h1 style={{
            ...
            fontSize: 22,
            fontWeight: 700,
            color: "var(--gg-text, rgb(236 240 245))",
            lineHeight: 1.3,
          }}>
            {headline}
          </h1>
