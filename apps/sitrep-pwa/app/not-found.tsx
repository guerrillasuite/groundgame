  ...
  return (
    <>
      <style>{`
        ...
        .sr-glitch-entrance { animation: sr-glitch-entrance 5s ease-out forwards; }
        .sr-glitch-idle     { animation: sr-glitch-idle 4s linear infinite; animation-delay: 5s; }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          >
            <span className="sr-glitch-idle">404</span>
          </span>
        </div>
